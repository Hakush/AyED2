...
int main(int argc, char const *argv[]) {
	...
	/* Este test no tiene mucho sentido en el contexto
	de implementar stack con un array */
	/*
	...
	printf("| Testing if pushing n elements (21) over m capacity (20) works |\n");
	stack s;
	s = stack_empty();
	for (int i = 0; i < 21; ++i)
	{
	...
	if (stack_size(s) == 21)
	{
		...
		printf("-------XXX---------TEST NOT PASSED-------XXX-----------\n");
	}
